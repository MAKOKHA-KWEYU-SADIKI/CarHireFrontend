...
//           <a className="link link-hover">infor@abdulAlli</a>
...
// //         <h6 className="footer-title">Social</h6>
// //         <div className="grid grid-flow-col gap-4">
// //           {/* Uncomment the following block to use local images */}
// //           {/* <a>
...
import image2 from '../userdashbord/assets/fb.png'
import image3 from '../userdashbord/assets/linkedin.png';
import image4 from '../userdashbord/assets/instagram.png';
